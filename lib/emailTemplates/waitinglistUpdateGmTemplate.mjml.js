// emailTemplates/waitinglistUpdateGmTemplate.mjml.js

const waitinglistUpdateGmTemplate = (data) => `
<mjml>
<mj-body background-color="#eceff1">
  ...
  <mj-section>
    ...
    <mj-text color="rgba(0, 0, 0, 0.6)">
      Ein Spieler ${data.oldPlayerName} hat sich bei deiner Spielrunde "${data.roundName}" abgemeldet.
    </mj-text>
    <mj-text color="rgba(0, 0, 0, 0.6)">
      Der Spieler ${data.newPlayerName} wurde von der Warteliste zu den Spielern verschoben und benachrichtigt.
    </mj-text>
    <mj-text color="rgba(0, 0, 0, 0.6)">
...
`;
export default waitinglistUpdateGmTemplate;
